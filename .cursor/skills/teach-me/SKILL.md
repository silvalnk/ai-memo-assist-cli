---
name: teach-me
description: Explains MemoAssist RAG and Skills to beginners in simple Portuguese. Use when the user asks what RAG, skill, dispatch, embedding, or chunking is, or how to use skills in a prompt in this lab.
---
